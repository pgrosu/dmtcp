...
#ifdef STATIC_DMTCP
# include "../include/static_dmtcp.h"
#endif
...
#define FOREACH_GLIBC_MALLOC_FAMILY_WRAPPERS(MACRO) \
  ...
  MACRO(malloc)                                     \
  MACRO(free)                                       \
/* Not in STATIC_DMTCP:  MACRO(__libc_memalign)*/   \
  MACRO(realloc)                                    \
  MACRO(mmap)                                       \
  MACRO(mmap64)                                     \
  MACRO(mremap)                                     \
...
#define FOREACH_GLIBC_WRAPPERS(MACRO) \
/* Not in STATIC_DMTCP:  MACRO(dlopen)*/                       \
/* Not in STATIC_DMTCP:  MACRO(dlclose)*/                      \
  MACRO(getpid)                       \
  MACRO(getppid)                      \
  MACRO(kill)                         \
                                      \
  ...
  MACRO(signal)                       \
  MACRO(sigaction)                    \
/* Not in STATIC_DMTCP:  MACRO(sigvec)*/                       \
                                      \
  MACRO(sigset)                       \
  MACRO(sigblock)                     \
  MACRO(sigsetmask)                   \
  ...
  MACRO(sighold)                      \
  MACRO(sigignore)                    \
/* Not in STATIC_DMTCP:  MACRO(__sigpause)*/                   \
  MACRO(sigpause)                     \
  MACRO(sigrelse)                     \
                                      \
  MACRO(sigwait)                      \
